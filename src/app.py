...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Practices: Mondays and Thursdays, 4:00 PM - 6:00 PM; Matches: Saturdays",
        "max_participants": 22,
    ...
    "Debate Team": {
        "description": "Practice debating skills, public speaking, and compete in tournaments",
        "schedule": "Mondays, 4:00 PM - 5:30 PM; tournament weekends",
        "max_participants": 14,
